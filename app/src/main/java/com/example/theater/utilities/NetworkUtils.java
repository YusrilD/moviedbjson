package com.example.theater.utilities;
...
import com.example.theater.Movies;
...
public class NetworkUtils {
    ...
    public static ArrayList<Movies> fetchData(String url) throws IOException {
    ...
    public static void parseJson(String data, ArrayList<Movies> list){
        ...
        try {
            ...
            for (int i = 0; i < resArray.length(); i++) {
                ...
                Movies movie = new Movies(); //New Movie object
